...
#define ESP_WIFI_SSID "Trang"
#define ESP_WIFI_PASS "0976078330"
...
void wifi_init_sta(void)
{
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        xTaskCreate(LED_Task, "LED", 4096, NULL, 10, &LEDTaskHandle);
...
void app_main(void) {
    ...
    //xTaskCreate(Blinky_Task, "Blinky", 4096, NULL, 10, &BlinkyTaskHandle);
